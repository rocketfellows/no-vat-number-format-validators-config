...
namespace rocketfellows\NOVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\NOVatNumberFormatValidatorsConfig\NOVatNumberFormatValidatorsConfig;

class NOVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = NOVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = NOVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::NO(), $config->getCountry());
    }
